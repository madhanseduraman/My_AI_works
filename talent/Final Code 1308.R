...
file1<-read_excel("C:\Users\Nisha.Nath\Documents\Talent\raw_file3107.xlsx",sheet = 1)
names(file1)
...
mod3<-glm(Target~ IT + NoticePeriod +`Big four`+ `hike%` +
              JoiningBonus +Experienced + dum_hiretype  + dum_title +
            dum_Source  + dum_Rank + dummy_IsRotationalShift + dum_Qual  ,data = train , family = "binomial")
